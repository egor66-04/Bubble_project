...
urlpatterns = [
    ...
    path('elements/<int:atomic_number>/', views.element_detail, name='element_detail'),
    ...
    path('api/toggle-favorite-element/', views.toggle_favorite_element, name='toggle_favorite_element'),
    path('api/toggle-favorite-element/<int:element_id>/', views.toggle_favorite_element, name='toggle_favorite_element_with_id'),
